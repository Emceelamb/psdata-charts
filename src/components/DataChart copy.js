...
// const BarChart = ({ data, keyval }) => <C3Chart data={{ json: data, type:'bar'}} />;
const BarChart = ({ data, keyval }) => <C3Chart data={{ json: data, type:'bar', keys: keyval }} />;
...
export default function DataChart() {
  ...
  return (
    <div>
      {/* <BarChart data={fdata} /> */}
      {console.log(fdata.length)}
      <BarChart data={fdata} keyval={keyval} />
    </div>
  )
}